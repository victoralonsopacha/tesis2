    ...
    <br>
        ...
        <form method="POST" id="reposicion_atraso" action="{{ route('tiempo_reposicions.store') }}">
            ...
            <div class="form-group row">
                <label for="staticEmail" class="col-sm-3 col-form-label">Cédula del usuario</label>
            ...
            <div class="form-group row">
                <label for="staticEmail" class="col-sm-3 col-form-label">Apellido del usuario</label>
                <div class="col-sm-9 col-md-6">
                    <input type="text" class="form-control" name="apellido" value="{{$cedula=auth()->user()->last_name}}" readonly>
                </div>
            </div>
            <div class="form-group row">
                <label for="staticEmail" class="col-sm-3 col-form-label">Cantidad de Tiempo</label>
                <div class="col-sm-9 col-md-6">
                    <input type="time" min="00:00" max="08:00" class="form-control" name="horas" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="staticEmail" class="col-sm-3 col-form-label">Día que desea reponer</label>
                <div class="col-sm-9 col-md-6">
